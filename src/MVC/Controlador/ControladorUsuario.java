 ...
 * @author Francisco
 */
public class ControladorUsuario implements Controller<Usuario>{
    protected Vista vista;
    protected ArrayList<Usuario> list;// un conjunto de datos 
    protected Usuario product;
    ...
    @Override
    public void create(Usuario modelo) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public void read(Usuario modelo) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
