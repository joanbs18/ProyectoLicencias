 ...
 * @author joans
 */
public class FrmRegistroSecretarias extends javax.swing.JFrame {

    int xMouse, yMouse;

    public FrmRegistroSecretarias() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRegistroSecretarias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRegistroSecretarias().setVisible(true);
            }
        });
    }
