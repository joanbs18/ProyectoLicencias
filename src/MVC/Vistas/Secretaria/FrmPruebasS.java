 ...
 * @author josep
 */
public class FrmPruebasS extends javax.swing.JFrame {
    int xMouse, yMouse;
    /**
    ...
    private void initComponents() {
        ...
        title.setText("SISTEMA PRUEBAS SECRETARIAS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPruebasS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPruebasS().setVisible(true);
            }
        });
    }
