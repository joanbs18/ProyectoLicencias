...
public class Prueba implements Modelo{
    ...
    public Prueba(Integer id, String fecha, Integer carnetOficial, Integer idCita, Double nota,Boolean estado, String observacion) {
        this.id = id;
        this.fecha = fecha;
    ...
    public boolean isComplete() {
        return !this.fecha.isEmpty() && this.carnetOficial!=null && this.idCita!=null && this.nota!=null && 
                this.nota!=null && this.estado!=null && this.obsevacion!=null;
    }

    @Override
    public String toString() {
        return "ModeloPrueba{" + "id=" + id + ", date=" + fecha + ", carnetOficial=" + carnetOficial + ", idCita=" + idCita + ", nota=" + nota + ", estado=" + estado + ", obsevacion=" + obsevacion + '}';
    }
